...
Manager::Manager(){
    ...
    this->m_motorRight = new Motor(PWMChannel_e::PWM2, MOTOR_RIGHT_PWM_GPIO, MOTOR_PWM_FREQUENCY, MOTOR_PWM_RESOLUTION, MOTOR_RIGHT_OFFSET, MOTOR_RIGHT_DIR_GPIO, MotorDirection_e::MOTOR_DIRECTION_INVERTED);
