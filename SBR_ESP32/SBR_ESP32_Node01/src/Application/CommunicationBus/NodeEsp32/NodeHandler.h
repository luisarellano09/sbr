...
RC_e ExtHandler(Request* request){
    ...
    switch(request->regId){
        ...
        case COM_REQUEST_REG_ID_e::MODE_NODE1_PROGRAM_W: {
            ...
            Log.traceln("[NodeHandler::MODE_NODE1_PROGRAM_W] Mode Program started");
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::MODE_NODE1_START_W: {
            ...
            Log.traceln("[NodeHandler::MODE_NODE1_START_W] Mode Motion started");
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::MODE_NODE1_STOP_W: {
            ...
            Log.traceln("[NodeHandler::MODE_NODE1_STOP_W] Mode Idle started");
            break;
        }
        
        case COM_REQUEST_REG_ID_e::SETUP_MOTOR_LEFT_OFFSET_W: {
            manager->m_motorLeft->SetOffset((double)request->data / 100.0);
            Log.traceln("[NodeHandler::SETUP_MOTOR_LEFT_OFFSET_W] Motor left offset setted: %D", manager->m_motorLeft->GetOffset());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTOR_LEFT_DIRECTION_W: {
            if ((bool)request->data == true){
                ...
                Log.traceln("[NodeHandler::SETUP_MOTOR_LEFT_DIRECTION_W] Motor left direction inverted: %T", manager->m_motorLeft->GetDirection());
            }
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTOR_RIGHT_OFFSET_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_MOTOR_RIGHT_OFFSET_W] Motor right offset setted: %D", manager->m_motorRight->GetOffset());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTOR_RIGHT_DIRECTION_W: {
            if ((bool)request->data == true){
                ...
                Log.traceln("[NodeHandler::SETUP_MOTOR_RIGHT_DIRECTION_W] Motor right direction inverted: %T", manager->m_motorRight->GetDirection());
            }
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_IMU_INVERT_PITCH_W: {
            if ((bool)request->data == true){
                ...
                Log.traceln("[NodeHandler::SETUP_IMU_INVERT_PITCH_W] IMU Pitch inverted: %T", manager->m_IMU->GetDirectionPitch());
            }
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_IMU_INVERT_ROLL_W: {
            if ((bool)request->data == true){
                ...
                Log.traceln("[NodeHandler::SETUP_IMU_INVERT_ROLL_W] IMU Roll inverted: %T", manager->m_IMU->GetDirectionRoll());
            }
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_IMU_INVERT_YAW_W: {
            if ((bool)request->data == true){
                ...
                Log.traceln("[NodeHandler::SETUP_IMU_INVERT_YAW_W] IMU Yaw inverted: %T", manager->m_IMU->GetDirectionYaw());
            }
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_IMU_OFFSET_PITCH_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_IMU_OFFSET_PITCH_W] IMU Pitch offset setted: %D", manager->m_IMU->GetPitchOffset());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_ENCODER_LEFT_DIRECTION_W: {
            if ((bool)request->data == true){
                ...
                Log.traceln("[NodeHandler::SETUP_ENCODER_LEFT_DIRECTION_W] Encoder left direction inverted: %T", manager->m_encoderLeft->GetDirection());
            }
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_ENCODER_RIGHT_DIRECTION_W: {
            if ((bool)request->data == true){
                ...
                Log.traceln("[NodeHandler::SETUP_ENCODER_RIGHT_DIRECTION_W] Encoder right direction inverted: %T", manager->m_encoderRight->GetDirection());
            }
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_ODOMETRY_WHEEL_RADIO_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_ODOMETRY_WHEEL_RADIO_W] Odometry Wheel radio setted: %D", manager->m_odometry->GetRadio());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_ODOMETRY_DISTANCE_WHEELS_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_ODOMETRY_DISTANCE_WHEELS_W] Odometry distance between wheels setted: %D", manager->m_odometry->GetDistanceWheels());
            break;
        }
        
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_PITCH_KP_W: {
            manager->m_motionControl->m_PIDPitch->SetKp((double)request->data / 1000.0);
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_PITCH_KP_W] Motion Control PID Pitch Kp setted: %D", manager->m_motionControl->m_PIDPitch->GetKp());
            break;
        }
        
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_PITCH_KI_W: {
            manager->m_motionControl->m_PIDPitch->SetKi((double)request->data / 1000.0);
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_PITCH_KI_W] Motion Control PID Pitch Ki setted: %D", manager->m_motionControl->m_PIDPitch->GetKi());
            break;
        }
        
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_PITCH_KD_W: {
            manager->m_motionControl->m_PIDPitch->SetKd((double)request->data / 1000.0);
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_PITCH_KD_W] Motion Control PID Pitch Kd setted: %D", manager->m_motionControl->m_PIDPitch->GetKd());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_PITCH_DIRECTION_W: {
            if ((bool)request->data == true){
                ...
                Log.traceln("[NodeHandler::SETUP_MOTION_PID_PITCH_DIRECTION_W] Motion Control PID Pitch direction inverted: %T", manager->m_motionControl->m_PIDPitch->GetDirection());
            }
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_PITCH_MV_MIN_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_PITCH_MV_MIN_W] Motion Control PID Pitch MV min setted: %D", manager->m_motionControl->m_PIDPitch->GetMVRangeMin());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_PITCH_MV_MAX_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_PITCH_MV_MAX_W] Motion Control PID Pitch MV max setted: %D", manager->m_motionControl->m_PIDPitch->GetMVRangeMax());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_POSITION_KP_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_POSITION_KP_W] Motion Control PID Position Kp setted: %D", manager->m_motionControl->m_PIDPosition->GetKp());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_POSITION_KI_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_POSITION_KI_W] Motion Control PID Position Ki setted: %D", manager->m_motionControl->m_PIDPosition->GetKi());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_POSITION_KD_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_POSITION_KD_W] Motion Control PID Position Kd setted: %D", manager->m_motionControl->m_PIDPosition->GetKd());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_POSITION_DIRECTION_W: {
            if ((bool)request->data == true){
                ...
                Log.traceln("[NodeHandler::SETUP_MOTION_PID_POSITION_DIRECTION_W] Motion Control PID Position direction inverted: %T", manager->m_motionControl->m_PIDPosition->GetDirection());
            }
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_POSITION_MV_MIN_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_POSITION_MV_MIN_W] Motion Control PID Position MV min setted: %D", manager->m_motionControl->m_PIDPosition->GetMVRangeMin());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_POSITION_MV_MAX_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_POSITION_MV_MAX_W] Motion Control PID Angle MV max setted: %D", manager->m_motionControl->m_PIDPosition->GetMVRangeMax());
            break;
        }

        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_ANGLE_KP_W: {
            manager->m_motionControl->m_PIDAngle->SetKp((double)request->data / 1000.0);
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_ANGLE_KP_W] Motion Control PID Angle Kp setted: %D", manager->m_motionControl->m_PIDAngle->GetKp());
            break;
        }

        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_ANGLE_KI_W: {
            manager->m_motionControl->m_PIDAngle->SetKi((double)request->data / 1000.0);
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_ANGLE_KI_W] Motion Control PID Angle Ki setted: %D", manager->m_motionControl->m_PIDAngle->GetKi());
            break;
        }

        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_ANGLE_KD_W: {
            manager->m_motionControl->m_PIDAngle->SetKd((double)request->data / 1000.0);
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_ANGLE_KD_W] Motion Control PID Angle Kd setted: %D", manager->m_motionControl->m_PIDAngle->GetKd());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_ANGLE_DIRECTION_W: {
            if ((bool)request->data == true){
                ...
                Log.traceln("[NodeHandler::SETUP_MOTION_PID_ANGLE_DIRECTION_W] Motion Control PID Angle direction inverted: %T", manager->m_motionControl->m_PIDAngle->GetDirection());
            }
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_ANGLE_MV_MIN_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_ANGLE_MV_MIN_W] Motion Control PID Angle MV min setted: %D", manager->m_motionControl->m_PIDAngle->GetMVRangeMin());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::SETUP_MOTION_PID_ANGLE_MV_MAX_W: {
            ...
            Log.traceln("[NodeHandler::SETUP_MOTION_PID_ANGLE_MV_MAX_W] Motion Control PID Angle MV max setted: %D", manager->m_motionControl->m_PIDAngle->GetMVRangeMax());
            break;
        }

        case COM_REQUEST_REG_ID_e::LIVE_MOTOR_LEFT_SPEED_W: {
            manager->m_motorLeft->SetSpeed((double)request->data / 100.0);
            Log.traceln("[NodeHandler::LIVE_MOTOR_LEFT_SPEED_W] Motor left speed setted: %D", manager->m_motorLeft->GetSpeed());
            break;
        }

        case COM_REQUEST_REG_ID_e::LIVE_MOTOR_RIGHT_SPEED_W: {
            manager->m_motorRight->SetSpeed((double)request->data / 100.0);
            Log.traceln("[NodeHandler::LIVE_MOTOR_RIGHT_SPEED_W] Motor right speed setted: %D", manager->m_motorRight->GetSpeed());
            break;
        }

        case COM_REQUEST_REG_ID_e::LIVE_ODOMETRY_X_W: {
            manager->m_odometry->SetX((double)request->data / 1000.0);
            Log.traceln("[NodeHandler::LIVE_ODOMETRY_X_W] Odometry X setted: %D", manager->m_odometry->GetX());
            break;
        }

        case COM_REQUEST_REG_ID_e::LIVE_ODOMETRY_Y_W: {
            manager->m_odometry->SetY((double)request->data / 1000.0);
            Log.traceln("[NodeHandler::LIVE_ODOMETRY_Y_W] Odometry Y setted: %D", manager->m_odometry->GetY());
            break;
        }

        case COM_REQUEST_REG_ID_e::LIVE_ODOMETRY_ANGLE_W: {
            manager->m_odometry->SetAngle((double)request->data / 100.0);
            Log.traceln("[NodeHandler::LIVE_ODOMETRY_ANGLE_W] Odometry Angle setted: %D", manager->m_odometry->GetAngle());
            break;
        }

        case COM_REQUEST_REG_ID_e::LIVE_ODOMETRY_DISTANCE_W: {
            manager->m_odometry->SetDistance((double)request->data / 1000.0);
            Log.traceln("[NodeHandler::LIVE_ODOMETRY_DISTANCE_W] Odometry Distance setted: %D", manager->m_odometry->GetDistance());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::LIVE_ODOMETRY_RESET_W: {
            if ((bool)request->data == true){
                ...
                Log.traceln("[NodeHandler::LIVE_ODOMETRY_RESET_W] Odometry resetted");
            }
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::LIVE_MOTION_SP_POSITION_W: {
            ...
            Log.traceln("[NodeHandler::LIVE_MOTION_SP_POSITION_W] Motion Control Position SP setted: %D", manager->m_motionControl->GetSPPos());
            break;
        }
        ...
        case COM_REQUEST_REG_ID_e::LIVE_MOTION_SP_ANGLE_W: {
            ...
            Log.traceln("[NodeHandler::LIVE_MOTION_SP_ANGLE_W] Motion Control Angle SP setted: %D", manager->m_motionControl->GetSPAngle());
            break;
        }
    }
