...
public:  
     ...
     * @return RC_e Result code
     */
    RC_e AddWriteRequest(COM_REQUEST_REG_ID_e regId, int32_t data);
...
private:
     ...
     * @return RC_e Result code
     */
    RC_e AddRequest(COM_REQUEST_TYPE_e type, COM_REQUEST_REG_ID_e regId, int32_t data);  
    ...
    /**
     * @brief Register Handler (Virtual)
     * 
     * @param regId Register ID
     * @param data Data value
     * @return RC_e Result code
     */
    RC_e virtual RegisterHandler(COM_REQUEST_REG_ID_e regId, int32_t data) = 0;
