...
impl RobotControl {
    ...
    pub fn run(&mut self) -> Result<(), Box<dyn Error>> {
        ...
        match (&self.state, event) {
            ...
            (RobotState::IdleMode(state_step), RobotEvent::None) => self.robot_state_idle_mode(state_step.clone())?,
            (RobotState::Move(state_step), RobotEvent::None) => self.robot_state_move(state_step.clone())?,
    ...
    fn robot_state_start_motion(&mut self, state_step: StateStep) -> Result<(), Box<dyn Error>> {
        ...
        self.state = RobotState::IdleMode(StateStep::Initialization);
    ...
    //=====================================================================================================
    fn robot_state_idle_mode(&mut self, state_step: StateStep) -> Result<(), Box<dyn Error>> {

        self.state = RobotState::Move(StateStep::Initialization);
    ...
    //=====================================================================================================
    fn robot_state_move(&mut self, state_step: StateStep) -> Result<(), Box<dyn Error>> {
